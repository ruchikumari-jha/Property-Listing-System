...
const BuyPage = ({ onLogout, navigateTo }) => {
    ...
    const properties = [
        ...
        },
        {
            ...
            baths: 5,
            sqft: '3,800',
            image: 'https://images.unsplash.com/photo-1493397212122-2b85def82824?q=80&w=2070&auto=format&fit=crop',
            featured: false
        },
        {
            id: 5,
                ...
                <div className="hidden lg:flex items-center gap-3">
                    {['Home', 'Buy', 'Rent', 'Sell', 'Plots'].map((item) => (
                        <button
                            ...
                            className={`px-6 py-2.5 rounded-xl text-[11px] font-black uppercase tracking-widest transition-all duration-300 ${item === 'Buy'
                ...
                <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-12">
                    <div className="max-w-2xl">
                        <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-6">
                            Exclusive <span className="text-emerald-600">Properties</span> For Sale
                        </h1>
                        <p className="text-gray-500 text-lg font-medium">
                            Browse through our handpicked collection of premium residential properties in the heart of Rajasthan's most prestigious locations.
                        </p>
                    </div>
